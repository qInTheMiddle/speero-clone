...
export default function Header() {
    ...
    useEffect(() => {
        // In Next.js, you should almost never use window.location to check the URL. Because Next.js renders components on 
        // the server first, window doesn't exist there, which can sometimes cause "hydration mismatch" errors.
        // const currentPath = window.location.pathname;
        // the correct way:
        if (pathname && pathname.includes('spare-parts/discover')) {
    ...
    return (
        <>
            ...
            {isDiscoverPage && (
                <div className="h-[72px] border-b border-[#e5e9f2] flex items-center justify-center">
                    <div className="w-full max-w-[1320px] box-border">
                        <a href="/" className="flex items-center">
                            <Image 
                                src="/image/logo/clone-logo.png" 
                                alt="Speero" 
                                width={100} 
                                height={49} 
